...
# Usage 
# ./proportion_DE_TEs_in_TEfams_hypergeometricTest.R ./FDR0.1/res_kssVwt_0.1_lfcShrink_Chr_upRegTEIDs.txt upReg "up-regulated" 100000 100,000

library(methods)

#DE_TEIDsFile <- "/home/ajt200/analysis/170918_Chris_RNAseq_Col_kss/fastq_pooled/DESeq2_TEs_analysis_01/FDR0.1/res_kssVwt_0.1_lfcShrink_Chr_upRegTEIDs.txt"
#reg <- "upReg"
