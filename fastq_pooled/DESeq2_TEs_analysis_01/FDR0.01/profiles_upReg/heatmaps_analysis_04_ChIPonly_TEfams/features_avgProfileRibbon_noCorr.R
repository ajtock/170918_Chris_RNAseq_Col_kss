...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript features_avgProfileRibbon_noCorr.R Upregulated_TEs_kss 'Upregulated TEs' 2000 2kb '2 kb' 20 20bp 'REC8_HA_Rep2,kss_REC8_HA_Rep1' 'wt REC8-HA,kss REC8-HA' 'red,red4' '0.02,0.94'
...
#featureNamePlot <- "Upregulated TEs"
#upstream <- 2000
#downstream <- 2000
#flankName <- "2kb"
#flankNamePlot <- "2 kb"
...
ggObj2 <- ggplot(data = summaryDFranLoc,
  ...
  theme(
        ...
        plot.margin = unit(c(0.3,0.9,0.0,0.3), "cm"), 
        plot.title = element_text(hjust = 0.5, size = 30)) +
  ggtitle(bquote("Non-DE TEs (" * italic("n") ~ "=" ~
