...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript features_avgProfileRibbon_DNAmeth_noCorr.R Upregulated_TEs_kss 'Upregulated' 2000 2kb '2 kb' 20 20bp 'mCHG,kss_mCHG' 'wt mCHG,kss mCHG' 'orange,orange4' '0.02,0.50'
