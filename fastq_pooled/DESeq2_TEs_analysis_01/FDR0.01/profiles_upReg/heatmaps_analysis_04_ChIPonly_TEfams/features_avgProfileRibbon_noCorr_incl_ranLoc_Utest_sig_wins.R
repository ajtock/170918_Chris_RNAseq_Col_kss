...
# Plot wt vs kss mean profiles with 95% confidence intervals as ribbons

# Usage:
# /applications/R/R-3.5.0/bin/Rscript features_avgProfileRibbon_noCorr_incl_ranLoc_Utest_sig_wins.R Upregulated_TEs_kss 'Upregulated' 2000 2kb '2 kb' 20 20bp 'REC8_HA_Rep2,kss_REC8_HA_Rep1' 'wt REC8-HA_Rep2,kss REC8-HA_Rep1' 'red,red4' '0.30,0.15' 0.1
...
# mC*: 'orange,orange4'
# RNA-seq: 'magenta,magenta4'

#featureName <- "Upregulated_TEs_kss"
#featureNamePlot <- "Upregulated"
#upstream <- 2000
#downstream <- 2000
#flankName <- "2kb"
#flankNamePlot <- "2 kb"
...
#                                        split = ",")))
## bottom center
#legendPos <- as.numeric(unlist(strsplit("0.30,0.15",
#                                        split = ",")))
