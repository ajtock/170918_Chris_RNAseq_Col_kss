...
matDir <- "/home/ajt200/analysis/170918_Chris_RNAseq_Col_kss/fastq_pooled/DESeq2_TEs_analysis_01/FDR0.01/profiles_upReg/matrices/"
plotDir <- "/home/ajt200/analysis/170918_Chris_RNAseq_Col_kss/fastq_pooled/DESeq2_TEs_analysis_01/FDR0.01/profiles_upReg/plots/"
...
outDFCM <- lapply(seq_along(libNames), function(x)
  list(paste0(matDir, libNames[[x]],
              "_norm_cov_upReg_TEs_mat1_smoothed_target_and_flank_dataframe_colMeans.txt"),
...
pdf(paste0(plotDir, "kss_upReg_FDR0.01_TEProfiles_wt_mutant_RNAseq_REC8_SPO11_1_oligos_CHGmeth_H3K9me2_SPO11_1_ChIP_MNase_winSize20_manuscript.pdf"), height = 17.5, width = 6)
par(mfrow = c(7, 2))
