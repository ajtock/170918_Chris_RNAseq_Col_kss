...
# csmit -m 20G -c 1 "./TE_Profiles_DNAmeth_commandArgs.R 2000 2kb 20 /home/ajt200/BS_Seq/Stroud_2013/WT_rep2/wig/bed/GSM980986_WT_rep2_CG.wig.bed.gr.tab.bed CGmeth 0.01"
...
DNAmethMatrix(signal = covGR,
              feature = DEtargetsGR,
              ranLoc = ranLocGR,
              featureSize = mean(width(DEtargetsGR)),
              flankSize = flankSize,
              winSize = winSize,
              DNAmethOutDF = outDF,
