...
pdf(paste0(plotDir, "kss_upReg_FDR0.01_geneProfiles_wt_mutant_RNAseq_REC8_SPO11_1_oligos_CHGmeth_H3K9me2_SPO11_1_ChIP_MNase_winSize20_manuscript.pdf"), height = 17.5, width = 6)
par(mfrow = c(7, 2))
