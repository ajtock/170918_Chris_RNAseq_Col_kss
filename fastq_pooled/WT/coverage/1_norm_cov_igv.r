...
dat.dir <- c("/home/meiosis/ajt200/analysis/170918_Chris_RNAseq_Col_kss/fastq_pooled/WT/")
# Amend as appropriate for your samples
lib.names1 <- c("WT_RNAseq_Chris_Rep1", "WT_RNAseq_Chris_Rep2")
# Amend as appropriate for your samples
lib.names2 <- c("WT_RNAseq_Chris_Rep1", "WT_RNAseq_Chris_Rep2")
lib.files1 <- paste0(dat.dir, lib.names1, "_STAR_mapped_both_sort.bam")
chr.index <- c(1:5)
# Amend as appropriate for your samples
out.dir <- c("/home/meiosis/ajt200/analysis/170918_Chris_RNAseq_Col_kss/fastq_pooled/WT/coverage/")
